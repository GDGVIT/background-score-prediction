...
emotion_model_path = 'Emotion Detection/model.h5' # Path for Emotion Classification Model
prototext = 'Emotion Detection/deploy.prototxt.txt' # Prototxt file for face detection
model = 'Emotion Detection/res10_300x300_ssd_iter_140000.caffemodel' # Model for face Detection

input_video = 'Enter path for the video' # Path for video
